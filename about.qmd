...
Below you can find a selection of my most valued tools from my tech stack roughly grouped by topic. Most tools are open source packages from my two main programming languages **R & Python**. My command of both of them, especially R, is advanced.
...
- **Package & Software Development**
  ...
  - R package development: `devtools`, `testthat`
  - Docker (compose)
  - Utils: `pre-commit`
- **Others**
  - LaTeX
