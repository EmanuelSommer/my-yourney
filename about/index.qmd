...
- **Reviewing Activities:** AISTATS, UAI, NeurIPS (Among the top reviewers 2025), ICLR
...
Below you can find a selection of some of my most valued tools from my tech stack roughly grouped by topic. Most tools are open source packages from my two main programming languages **{{< fa brands r-project >}} & Python {{< fa brands python >}}**. My command of both of them is advanced.
...
- **Machine Learning & Statistical Modeling**
  ...
  - Statistical Modeling: `tidymodels`, `sklearn`, `lightgbm`, `numpyro`, `blackjax`
